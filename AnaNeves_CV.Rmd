...
data <- rbind(
  tibble(
    Position = "Doctoral Tutor for Analysing Data",
    Date = "Jan-Apr, 2026",
    Institution = "University of Sussex",
    Where = "Brighton, UK",
    Activity = paste0("Provided tutorial support for first-year undergraduate psychology students in R programming, data wrangling, data visualisation, and statistical analysis (correlations, t-tests, chi-squared tests, and linear regression).")
  ), 
  tibble(
...
**Neves, A.**, Pfaff, M., Scharte, R., Nogueira-Arjona, R., Poerio, L, G., Makowski, D. (2026). [Mega-analysis of the Interoceptive Accuracy Scale (IAS) Structure andits Dispositional Correlates](https://osf.io/preprints/psyarxiv/2mpqd_v2)

Makowski, D., **Neves, A.**(2026). [Testing the Relationship between Phenomenological Control related to Illusion Sensitivity](https://osf.io/preprints/psyarxiv/873th_v7)

Makowski, D., **Neves, A.**, Benn, E. L., Bennett, M., & Poerio, G. (2026). [The Mint Scale: A Fresh Validation of the Multimodal Interoception Questionnaire and Comparison to the MAIA, BPQ and IAS](https://osf.io/preprints/psyarxiv/8qrht_v1)

Pham, T., Johnco, C., **Neves, A.**, Lim, W., Heng, G., Ygnacio, R., & Forbes, M. (2026). [A Meta-analysis of Heart Rate Variability (HRV) and Psychopathology: An Investigation Guided by the Hierarchical Taxonomy of Psychopathology (HiTOP) Framework.](https://osf.io/preprints/psyarxiv/zu8aq_v1) 
\normalsize

Scharte, R. E., Greenwood, K., Romero Sanchiz, P., **Neves, A.**, Makowski, D., & Nogueira-Arjona, R. (2026) [Interoception and Substance use: A systematic review and meta-analysis.](https://osf.io/preprints/psyarxiv/gzv78_v1)
...
**Neves, A.**, Viola, M., Sperduti, M., Marini, M., Ansani, A.,Olivera La Rosa .A., Corradi, G., & Makowski, D. (2026). *Do we find AI-Generated content less emotional? The impact of Reality Beliefs on Affective Responses*,  8th European Society for Cognitive and Affective Neuroscience Meeting, June 3-6, Rome, Italy. 
...
**Neves, A.**, Viola, M., Sperduti, M., Marini, M., Ansani, A.,Olivera La Rosa .A., Corradi, G., & Makowski, D. (2025). *Do We Find AI-Generated Less Emotional? The Impact Of Reality Beliefs On Affective Responses*, 28th  Association for the Scientific Study of Consciousness, July 6-9, Heraklion, Crete.
